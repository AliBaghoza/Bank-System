...
private:
    ...
    static void PrintTransferLogRecordLine(clsBankClient::stTransferLog LoginRegisterRecord)
    {
        ...
        cout << "| " << setw(8) << left << LoginRegisterRecord.AccountSourceClient;
        cout << "| " << setw(8) << left << LoginRegisterRecord.AccountDestinationClient;
        cout << "| " << setw(8) << left << LoginRegisterRecord.Amount;
        cout << "| " << setw(10) << left << LoginRegisterRecord.BalanceSourceClient;
        cout << "| " << setw(10) << left << LoginRegisterRecord.BalanceDestinationClient;
